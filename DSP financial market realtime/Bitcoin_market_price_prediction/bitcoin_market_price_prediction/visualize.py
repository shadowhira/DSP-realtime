...
def plot_basic(stocks, title='Yahoo Trading', y_label='Price USD', x_label='Trading Days'):
    """
    Plots basic pyplot
...
def plot_prediction(actual, prediction, title='Yahoo Trading vs Prediction', y_label='Price USD', x_label='Trading Days'):
    """
...
def plot_lstm_prediction(actual, prediction, title='Yahoo Trading vs Prediction', y_label='Price USD', x_label='Trading Days'):
    """
    Plots train, test and prediction
    :param actual: DataFrame containing actual data
    :param prediction: DataFrame containing predicted values
